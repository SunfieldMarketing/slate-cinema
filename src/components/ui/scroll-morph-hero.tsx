    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Back Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-[#00AEEF] flex flex-col items-center justify-center p-4 border border-white/20"
                    style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-[#030305] uppercase tracking-widest mb-1">View</p>
            ...
            <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: '1000px' }}>
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    <motion.h1
                        ...
                        className="text-2xl font-bold tracking-tight text-white md:text-5xl"
                    >
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-xs font-mono tracking-[0.4em] text-[#00AEEF] uppercase"
                    >
                ...
                >
                    <span className="font-mono text-[10px] text-[#00AEEF] tracking-[0.4em] uppercase block mb-4">// Featured Work</span>
                    <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight mb-4">
                        Cinematic Excellence
                    </h2>
                    <p className="text-sm md:text-base text-white/50 max-w-lg leading-relaxed">
                        Scroll through our curated collection of high-end productions, brand campaigns, and visual masterpieces.
                    </p>
                </motion.div>
