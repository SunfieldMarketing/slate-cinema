...
const steps = [
  {
    ...
    gradient: 'from-[#00AEEF]/5 via-[#0066AA]/5 to-transparent',
  },
  {
    num: '02',
    title: 'Production',
    ...
    gradient: 'from-[#00AEEF]/5 via-[#0088CC]/5 to-transparent',
  },
  {
    num: '03',
    ...
    gradient: 'from-[#00AEEF]/5 via-[#005599]/5 to-transparent',
  },
  {
    num: '04',
    title: 'Distribution',
    ...
    gradient: 'from-[#00AEEF]/5 via-[#003377]/5 to-transparent',
  },
]
...
export default function Pipeline() {
  ...
  useGSAP(() => {
    ...
    const segSize = 1200 / steps.length // vh per step segment
  ...
  return (
    /* 1300vh tall scrollable wrapper — gives us 1200vh of pinned scroll room */
    <div ref={wrapperRef} style={{ height: '1300vh' }}>
            ...
            {steps.map((step, i) => (
              <div key={i} className="absolute inset-0">
                ...
                <div
                  ...
                  style={{ background: 'linear-gradient(to top, rgba(3,3,5,0.4) 0%, transparent 40%)' }}
                />
