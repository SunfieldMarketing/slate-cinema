...
/*
  ...
  layout's metadata, and for why the header now uses the real, shared
  <Nav /> instead of a hand-rolled one (2026-08-13, Kauan flagged the
  visual mismatch). The Privacy link inside this page is the absolute
